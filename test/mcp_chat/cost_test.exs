defmodule MCPChat.CostTest do
  ...
  describe "calculate_session_cost/2" do
    test "calculates cost for Anthropic Claude model" do
      ...
      assert cost_info.input_cost == 0.00025
      assert cost_info.output_cost == 0.000625
      assert cost_info.total_cost == 0.000875
    end
    ...
    test "calculates cost for OpenAI GPT model" do
      ...
      assert cost_info.output_cost == 0.0015
      assert cost_info.total_cost == 0.0025
    end
  ...
  describe "format_cost/1" do
    test "formats very small costs in cents" do
      assert Cost.format_cost(0.00001) == "$0.001¢"
      assert Cost.format_cost(0.0005) == "$0.050¢"
