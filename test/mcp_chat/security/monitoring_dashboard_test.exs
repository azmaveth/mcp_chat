defmodule MCPChat.Security.MonitoringDashboardTest do
  ...
  describe "Real-time metrics" do
    test "provides real-time metrics snapshot" do
      ...
      assert abs(now - metrics.timestamp) < 5000  # Within 5 seconds
      ...
      expected_keys = [:active_capabilities, :violations_1h, :security_kernel_status, :audit_buffer_size, :active_agents]
