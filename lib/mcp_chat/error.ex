defmodule MCPChat.Error do
  @moduledoc """
  Standardized error types and utilities for MCPChat libraries.

  This module defines consistent error patterns used throughout MCPChat modules
  ...
  @doc """
  Creates a standardized file operation error.

  ## Parameters
  - `reason` - File operation failure reason

  ## Returns
  File error tuple
  """
  @spec file_error(term()) :: {:error, {:file_error, term()}}
