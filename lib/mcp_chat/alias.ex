defmodule MCPChat.Alias do
  ...
  defp is_reserved_command?(name) do
    ...
    reserved = [
      "help", "clear", "history", "new", "save", "load", "sessions",
      "config", "servers", "discover", "connect", "disconnect",
      "tools", "tool", "resources", "resource", "prompts", "prompt",
      "backend", "model", "export", "context", "system", "tokens",
      "strategy", "cost", "alias", "exit", "quit"
    ]
